...
// Source: libs/pixi.js/index.d.ts
declare module PIXI {
...
// Generated by typings
// Source: libs/webfontloader/index.d.ts
...
declare namespace Lightning {
    class Event {
         ...
         */
        addSubscriber(fn: Function, ctx: Object, once?: boolean, params?: any): iEventSubscription;
        /**
         ...
         * @returns {void}
         */
        emit(fromEmitter?: boolean, ...params: any[]): void;
        /**
         ...
         */
        emitOnce: boolean;
        readonly subscribers: Array<iEventSubscription>;
    }
}
declare namespace Lightning {
    class EventEmitter {
         ...
         * @returns {Event}
         */
        subscribe(key: string, fn: Function, ctx?: Object, ...params: Array<any>): iEventSubscription;
        /**
         ...
         * @returns {Event}
         */
        subscribeOnce(key: string, fn: Function, ctx?: Object, ...params: Array<any>): iEventSubscription;
        /**
         ...
         * @returns {void}
         */
        unsubscribe(key: string, event: iEventSubscription): void;
        /**
         ...
         * @returns {boolean}
         */
        enableEvent(key: string): boolean;
        /**
         ...
         * @returns {boolean}
         */
        disableEvent(key: string): boolean;
        /**
...
declare namespace Lightning {
    class Plugin {
        ...
        constructor(game: Engine, updateLoop?: boolean, events?: boolean);
        protected update(time: number): void;
        protected enableUpdate(): void;
        protected removeUpdate(): void;
        protected enableEvents(): void;
        readonly events: EventEmitter;
    }
}
declare namespace Lightning {
    class AudioManager extends Plugin {
        protected game: Engine;
        protected _sounds: {
            [key: string]: Howl;
        };
        ...
        load(key: string, src: Array<string>, autoplay?: boolean, loop?: boolean, volume?: number): Howl;
        sound(key: string): Howl;
...
declare namespace Lightning {
    class Scale extends EventEmitter {
        ...
        private setup(initWidth, initHeight);
        private calculateDPR();
        private calculateOrientation();
        resizeThrottler(force?: boolean): void;
        resize(width: number, height: number): void;
...
declare namespace Lightning {
    class Request {
        ...
        constructor(service: Service, route: string, actionType: string, headers?: Array<{
            content: string;
            value: any;
...
declare namespace Lightning {
    class Service {
        ...
        call(key: string, headers?: Array<{
            content: string;
            value: string;
        }>, body?: any): Request;
        destroy(): boolean;
        despose(request: Request): boolean;
        create(actionType: string, route: string, headers?: Array<{
            content: string;
            value: any;
...
declare namespace Lightning {
    class Device {
        ...
        private _isEdge;
        private _isSafari;
        private _isBrowserUnknown;
        private _browserInfo;
        private _browserVersion;
        private _touchAvailable;
        private _mouseAvailavle;
        private _pointerAvailable;
        constructor(game: Engine);
        private osDetection();
...
declare namespace Lightning {
    class Maths {
         ...
         * ~~~
         */
        static rndPos(rectangle: iRec): iPoint;
        /**
         ...
         * ~~~
         */
        static distanceBetween(obj1: iPoint, obj2: iPoint): number;
        /**
         * FINISH EXAMPLE
        ...
        */
         ...
         * ~~~
         */
        static closestValue(array: Array<number>, value: number): number;
        /**
         ...
         * ~~~
         */
        static shuffleArray(array: Array<any>): any[];
        /**
         ...
         * ~~~
         */
        static roundUpToNearest(number: number, roundTo: number): number;
        /**
         ...
         * ~~~
         */
        static roundDownToNearest(number: number, roundTo: number): number;
        /**
         ...
         * ~~~
         */
        static uniqueRange(from: number, to: number, count: number, safeNumber?: number): number[];
        /**
         ...
         * ~~~
         */
        static contains(array: Array<any>, element: any): boolean;
        /**
...
declare namespace Lightning {
    class Debug {
        ...
        private _maxSegmentsToShow;
        private _wInc;
        private _cPos;
        private _minLineHeight;
        private _maxLineHeight;
        private _paddingTop;
        private _dataArray;
        private _currentDataSelector;
        constructor(game: Engine, chartWidth?: number, chartHeight?: number, segmentation?: number, maxSegment?: number);
        createChart(): void;
        update(): void;
...
declare namespace Lightning {
    class WebFontLoader extends EventEmitter {
        constructor();
        load(config: WebFont.Config): void;
        onLoad(): void;
        loadComplete(): void;
        failed(): void;
    }
...
declare namespace Lightning {
    class Locale {
         ...
         * @returns {void}
         */
        private checkLanguageExists(defaultLang);
        /**
         *
         * @param key
         * @param params
         ...
         * @param arg2
         */
        setArgs(arg1: string, arg2: string): void;
        /**
...
declare namespace Lightning {
    class Logger {
        ...
        private static _reportLogLevel;
        private static _service;
        private static _action;
        static log(level: number, log: string): void;
        private static logError(log, stackTrace);
        private static logWarning(log, stackTrace);
        private static logInfo(log, stackTrace);
        private static reportLogError(log, stackTrace);
        private static reportLogWarning(log, stackTrace);
        private static reportLogInfo(log, stackTrace);
        static logLevel: number;
        static reportLogLevel: number;
    }
}
declare namespace Lightning {
    class Input {
...
declare namespace Lightning {
    class Text extends PIXI.Text {
        globalRef: string;
        constructor(text: string, style: PIXI.ITextStyleStyle, canvas?: HTMLCanvasElement);
        update(time: number): void;
    }
}
declare namespace Lightning {
...
declare namespace Lightning {
    class Sprite extends PIXI.Sprite {
        ...
        enableInput(): void;
        enableUpdate(event: Lightning.Event): void;
        destroy(): void;
        /**
         * @param  {boolean} val
         */
        enablePhysicsBody(): void;
        /**
         * @param  {number} aX
         * @param  {number=aX} aY
         * @returns void
...
declare namespace Lightning {
    class Geometry {
         ...
         */
        static Square(d: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Rect(w: number, h: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static RoundRect(w: number, h: number, radius: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Ellipse(w: number, h: number, radius: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Star(cx: number, cy: number, spikes: number, outerRadius: number, innerRadius: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        /**
        ...
        * @returns {Lightning.Graphics}
        */
        static Polygon(cx: number, cy: number, sides: number, size: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Heart(ratio: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Circle(r: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Oval(centerX: number, centerY: number, width: number, height: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Triangle(l1: number, l2?: number, tint?: number, alpha?: number, returnAsTexture?: boolean): Lightning.Graphics | Lightning.Texture;
        static MultiShape(shapes: Array<{
            shape: string;
            x?: number;
            y?: number;
            tint?: number;
...
declare namespace Lightning {
    class Particle extends ParticleBase {
        protected onCreateAnimation: any;
        protected onCompleteAnimation: any;
        protected animationPath: any;
...
declare namespace Lightning {
    class ParticleEmitter extends Group {
        ...
        obstacles: Array<any>;
        constructor(state: Scene, x?: number, y?: number);
        private tick(time);
        updateTransform(): void;
        /**
         * @param  {string} key
...
declare namespace Lightning {
    class TweenManeger extends Plugin {
        protected game: Engine;
        private _active;
        private _tweens;
        private _toBeDestroyed;
        constructor(game: Engine);
        protected update(dt: number): void;
        create(objRef: DisplayObject, autoDestroy?: boolean, key?: string): Tween;
        start(tween: string | Tween): void;
        destroy(tween: string | Tween): any;
        /**
         * probably not going to work, needs to be refatored
         */
        getTween(key: string): any;
...
declare namespace Lightning {
    ...
    class Tween extends EventEmitter {
        ...
        private _toSkip;
        private _toBeDestroyed;
        constructor(manager: TweenManeger, obj: DisplayObject, autoDestroy?: boolean);
        update(dt: number): void;
        createAnim(from: number, to: number, time: number, property: string, easing: Function, delay?: number): void;
        importAnim(property: string, frames: Array<number | string>, delay?: number): void;
        exportAnim(key: string): any;
        start(): void;
        private complete();
        ...
        destroy(): void;
        reset(): void;
        moveTo(frame: number): number;
        chain(...tweens: Array<Tween>): void;
...
declare namespace Lightning {
    ...
    class Easing {
        ...
        static ElasticIn(t: number, b: number, c: number, d: number): number;
        static ElasticOut(t: number, b: number, c: number, d: number): number;
        static ElasticInOut(t: number, b: number, c: number, d: number): number;
 ...
 */
declare namespace Lightning {
    class LitePhysicsBody {
        private _drag;
        private _bounds;
        private _hasMultipleBounds;
        private _velocity;
        private _mass;
        private _static;
        private _active;
        private _destroyFlag;
        private _graphics;
        private _deltaG;
        private _pauseCollisionDetection;
        private _collideOnWorldBounds;
        ...
        y: number;
        private _objectRef;
        constructor(obj: any, inheritAnchor?: boolean);
        accelerateTo(): void;
        updateObjectRefPosition(): void;
        ...
        velocity: iVector;
        static: boolean;
        hasMultipleBounds: boolean;
        destroyFlag: boolean;
        collideOnWorldBounds: boolean;
        gravityEnabled: boolean;
        objRef: DisplayObject;
        pauseCollisionDetection: boolean;
        deltaG: iVector;
    }
}
/**
 ...
 */
declare namespace Lightning {
    class LitePhysicsPool {
        private _enabled;
        private _bodies;
        private _selfCollide;
        private _destroyFlag;
        constructor(selfCollide: boolean);
        add(...bodies: Array<LitePhysicsBody>): Array<LitePhysicsBody>;
        destroy(): void;
        remove(...bodies: Array<LitePhysicsBody>): Array<LitePhysicsBody>;
        enabled: boolean;
        selfCollide: boolean;
        bodies: Array<LitePhysicsBody>;
    }
}
/**
 * Physice Lite Pool
 ...
 */
declare namespace Lightning {
    class LitePhysicsCollisionEvent extends EventEmitter {
        private _isEnabled;
        private _oneWayCollision;
        private _b1;
        private _b2;
        private _destroyFlag;
        private _onCollideCallback;
        constructor(objects1: Array<LitePhysicsBody>, objects2: Array<LitePhysicsBody>, oneWayCollision?: boolean);
        onCollide(fn: Function, ctx?: Object, ...params: any[]): void;
        collisionDetected(b1: LitePhysicsBody, b2: LitePhysicsBody): void;
        destroy(): void;
        enabled: boolean;
        oneWayCollision: boolean;
        b1: Array<LitePhysicsBody>;
        b2: Array<LitePhysicsBody>;
        readonly bodies: Array<LitePhysicsBody>;
    }
}
/**
 * TODO
 ...
 */
declare namespace Lightning {
    class LitePhysicsManager extends Plugin {
        protected game: Engine;
        private _enabled;
        private _paused;
        private _pools;
        ...
        private postUpdate();
        protected update(dt: number): void;
        createPool(key: string, selfCollide?: boolean, ...objects: Array<LitePhysicsBody>): LitePhysicsPool;
        createCollisionEvent(key: string, objects1: any, objects2: any): LitePhysicsCollisionEvent;
        removePool(key: string): void;
        pool(key: string): LitePhysicsPool;
        collisionEvents(key: string): LitePhysicsCollisionEvent;
        removeCollisionEvents(key: string): void;
        reset(): void;
        updatePosition(body: LitePhysicsBody): void;
        private checkWorldCollide(body);
        private calculateGravity(body);
        private checkCollisions(collisionEvent);
        private checkPoolCollisions(pool);
        private AABBvsAABB(b1, b2);
        private resolveAABB(b1, b2);
        private outOfBounds(body);
    }
}
declare namespace Lightning {
    class Cache {
...
declare namespace Lightning {
    class StorageManager {
        private _isLS;
        private _map;
        private _forceNoLocalStorage;
        constructor(forceNoLocalStorage?: boolean);
        /**
         *
         * @param key
         * @param val
...
declare namespace Lightning {
    class EngineHelper {
        ...
        enableDebug(game: Engine): void;
        recycle(obj: any): void;
        backgroundColor: number;
        readonly world: Lightning.Group;
         ...
         * @returns {number}
         */
        displayCount(rootObject: Lightning.DisplayObject): number;
        /**
         ...
         * @returns {number}
         */
        getObjectsByReference(rootObject: Lightning.DisplayObject, ...refs: any[]): Array<Lightning.DisplayObject>;
...
declare namespace Lightning {
    class Scene extends Lightning.Group {
        game: Engine;
 ...
 */
declare namespace Lightning {
    class SceneManager extends Plugin {
        protected game: Engine;
         ...
         */
        start(key: any, destroyCurrentScene?: boolean, autoInit?: boolean, ...params: any[]): void;
        /**
         ...
         * @returns {boolean}
         */
        init(map: iSceneMap, ...params: any[]): void;
        /**
         ...
         */
        destroy(key: string): boolean;
        private destroyAllChildren(rootObject);
        /**
         ...
         * @returns {boolean}
         */
        add(key: string, scene: Scene): boolean;
        /**
         ...
         * @returns {boolean}
         */
        private addToActive(map);
        private isActive(map);
        /**
         * TODO
...
declare namespace Lightning {
    class Engine extends EngineHelper {
        ...
        private initialize(width, height, options);
        /**
