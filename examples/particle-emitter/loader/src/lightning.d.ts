...
declare namespace Lightning {
    class AudioManager extends Plugin {
        ...
        load(key: string, src: any): Howl;
        sound(key: string): Howl;
        destroy(key: string): boolean;
        play(key: string, loop?: boolean, volume?: number): number;
        /**
         * @todo
...
declare namespace Lightning {
    class Scale extends EventEmitter {
        ...
        constructor(game: Engine, initWidth: number, initHeight: number, scaleMode?: number, allowedDPR?: number[]);
...
declare namespace Lightning {
    class Maths {
        ...
        static angleBetweenDegs(a: any, b: any, c: any, d: any): number;
        /**
        ...
        */
        ...
        static isEven(val: number): number;
        /**
         ...
         * ~~~
         */
        static pointsOfCircle(x: any, y: any, points: any, radius: any): {
            x: number[];
            y: number[];
        };
    }
...
declare namespace Lightning {
    class Utils {
        ...
        static randomInArray(array: any[], rangeFrom?: number, rangeTo?: number): any;
        static randomString(): void;
        /**
...
declare namespace Lightning {
    ...
    class Loader extends PIXI.loaders.Loader {
         ...
         * ~~~
         */
        addResource(name: string, url: string[], options?: iLoaderOptions): void;
        /**
        ...
        private addToLoader(name, url, options?);
        private preloadError(err);
        private audioLoaded(sound);
        private preloadSingle(loader, resource);
...
declare namespace Lightning {
    class Logger {
         ...
         */
        private _logLevel;
        private _reportLogLevel;
        private _service;
        private _action;
        log(log: string): void;
        private logError(log, stackTrace);
        private logWarning(log, stackTrace);
        private logInfo(log, stackTrace);
        private reportLogError(log, stackTrace);
        private reportLogWarning(log, stackTrace);
        private reportLogInfo(log, stackTrace);
        logLevel: 0 | 1 | 2 | 3;
        reportLogLevel: 0 | 1 | 2 | 3;
    }
}
declare namespace Lightning {
    class Input {
...
declare namespace Lightning {
    class Text extends PIXI.Text {
        globalRef: string;
        constructor(text: string, style: iTextStyle, canvas?: HTMLCanvasElement);
        /**
         * @param  {number} aX
         * @param  {number=aX} aY
         * @returns void
...
declare namespace Lightning {
    class Animation extends PIXI.extras.AnimatedSprite {
        constructor(texture: Lightning.Texture | string | string[] | Lightning.Texture[], frames?: number, width?: number, height?: number);
        reset(): void;
    }
}
declare namespace Lightning {
...
declare namespace Lightning {
    class Geometry {
         ...
         */
        static Square(d: number, tint?: number, alpha?: number): Lightning.Graphics;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Rect(w: number, h: number, tint?: number, alpha?: number): Lightning.Graphics;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static RoundRect(w: number, h: number, radius: number, tint?: number, alpha?: number): Lightning.Graphics;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Ellipse(w: number, h: number, radius: number, tint?: number, alpha?: number): Lightning.Graphics;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Star(cx: number, cy: number, spikes: number, outerRadius: number, innerRadius: number, tint?: number, alpha?: number): Lightning.Graphics;
        /**
        ...
        * @returns {Lightning.Graphics}
        */
        static Polygon(cx: number, cy: number, sides: number, size: number, tint?: number, alpha?: number): Lightning.Graphics;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Heart(ratio: number, tint?: number, alpha?: number): Lightning.Graphics;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Circle(r: number, tint?: number, alpha?: number): Lightning.Graphics;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Oval(centerX: number, centerY: number, width: number, height: number, tint?: number, alpha?: number): Lightning.Graphics;
        /**
         ...
         * @returns {Lightning.Graphics}
         */
        static Triangle(l1: number, l2?: number, tint?: number, alpha?: number): Lightning.Graphics;
...
declare namespace Lightning {
    class TweenManeger extends Plugin {
        ...
        create(objRef: any, autoDestroy?: boolean, key?: string): Tween;
        clone(tween: string | Tween, objRef: any): Tween;
...
declare namespace Lightning {
    ...
    class Tween extends EventEmitter {
        ...
        private _interval;
        private _frames;
        private _staticAnimations;
        private _liveAnimations;
        private _length;
        ...
        readonly liveAnimations: iLiveAnimation[];
        readonly staticAnimations: iStaticAnimation[];
        active: boolean;
        loops: number;
        readonly fps: number;
...
declare namespace Lightning {
    class Timer {
        ...
        private _interval;
        private _active;
        constructor(game: Engine | Scene, interval?: number, autoStart?: boolean, loop?: boolean, autoDestroy?: boolean);
...
declare namespace Lightning {
    class PhysicsManager {
        ...
        startPhysics(): void;
        setupDebugDraw(): void;
        createBody(displayObject: any, shape?: "square" | "circle" | "polygon", vertices?: Array<number>): Box2D.Dynamics.b2Body;
        createLine(x: number, y: number, p1x: number, p1y: number, p2x: number, p2y: number): void;
...
declare namespace Lightning {
    class PhysicsBody extends Box2D.Dynamics.b2Body {
